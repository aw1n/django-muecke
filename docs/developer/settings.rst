...
``muecke_project/settings``. For Django's default settings which are also relevant
...
.. _settings_muecke_price_calculators:
...
.. _settings_muecke_shipping_price_calculators:
...
PAYPAL_RECEIVER_EMAIL
    Your PayPal id, e.g. info@getmuecke.com.
