...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_shop', (
            ...
            ('price_calculator', self.gf('django.db.models.fields.CharField')(default='muecke.gross_price.GrossPriceCalculator', max_length=255)),
    ...
    models = {
        ...
        'core.shop': {
            ...
            'price_calculator': ('django.db.models.fields.CharField', [], {'default': "'muecke.gross_price.GrossPriceCalculator'", 'max_length': '255'}),
