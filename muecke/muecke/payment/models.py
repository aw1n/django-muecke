...
class PaymentMethod(models.Model):
    ...
    **Attributes:**
    ...
    type = models.PositiveSmallIntegerField(_(u'Type'), choices=muecke.payment.settings.PAYMENT_METHOD_TYPES_CHOICES, default=muecke.payment.settings.PM_PLAIN)
...
# See https://bitbucket.org/diefenbach/django-muecke/issue/197
