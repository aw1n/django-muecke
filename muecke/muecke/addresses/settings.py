...
ADDRESS_MODEL = getattr(settings, "LFS_ADDRESS_MODEL", "muecke.addresses.models.Address")
SHIPPING_ADDRESS_FORM = getattr(settings, "LFS_SHIPPING_ADDRESS_FORM", "muecke.addresses.forms.ShippingAddressForm")
INVOICE_ADDRESS_FORM = getattr(settings, "LFS_INVOICE_ADDRESS_FORM", "muecke.addresses.forms.InvoiceAddressForm")
