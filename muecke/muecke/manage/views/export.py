...
from muecke.export.settings import CATEGORY_VARIANTS_CHOICES
from muecke.export.settings import CATEGORY_VARIANTS_NONE
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(
                reverse("muecke_export", kwargs={"export_id": new_export.id}))
...
def export_dispatcher(request):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse("muecke_export_add_export"))
    else:
        return HttpResponseRedirect(
            reverse("muecke_export", kwargs={"export_id": export.id}))
...
def delete_export(request, export_id):
    ...
    return HttpResponseRedirect(reverse("muecke_export_dispatcher"))
...
def export(request, slug):
    ...
    module = muecke.core.utils.import_module(export.script.module)
