...
def delete_review(request, review_id):
    ...
    try:
        ...
        url = reverse("muecke_manage_reviews")
    else:
        url = reverse("muecke_manage_review", kwargs={"review_id": review.id})

    return muecke.core.utils.set_message_cookie(url, _(u"Review has been deleted."))
