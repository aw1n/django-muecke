...
from muecke.manage.discounts.forms import DiscountForm
...
def manage_discounts(request):
    ...
    try:
        ...
        url = reverse("muecke_manage_no_discounts")
    else:
        url = reverse("muecke_manage_discount", kwargs={"id": discount.id})
...
def manage_discount(request, id, template_name="manage/discounts/discount.html"):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse("muecke_manage_discounts"))
...
def delete_discount(request, id):
    ...
    return muecke.core.utils.set_message_cookie(
        url=reverse("muecke_manage_discounts"),
