...
from muecke.catalog.settings import CATEGORY_VARIANT_CHOICES
...
from muecke.catalog.settings import VARIANT, PROPERTY_SELECT_FIELD
...
def _selectable_products_inline(request, product):
    ...
    from muecke.manage.product.product import selectable_products_inline
    from muecke.manage.product.product import _get_filtered_products_for_product_view
    from muecke.manage.product.product import get_current_page
