...
from muecke.manage.manufacturers.forms import ManufacturerDataForm
...
def add_manufacturer(request, template_name="manage/manufacturers/add_manufacturer.html"):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(
                reverse("muecke_manufacturer", kwargs={"manufacturer_id": new_manufacturer.id}))
    ...
    return render_to_response(template_name, RequestContext(request, {
        ...
        "came_from": request.REQUEST.get("came_from", reverse("muecke_manufacturer_dispatcher")),
    }))
...
def manufacturer_dispatcher(request):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse("muecke_manage_no_manufacturers"))
    else:
        return HttpResponseRedirect(
            reverse("muecke_manufacturer", kwargs={"manufacturer_id": manufacturer.id}))
...
def delete_manufacturer(request, manufacturer_id):
    ...
    return HttpResponseRedirect(reverse("muecke_manufacturer_dispatcher"))
