...
from muecke.manage.property.forms import PropertyAddForm
from muecke.manage.property.forms import PropertyDataForm
from muecke.manage.property.forms import PropertyTypeForm
from muecke.manage.property.forms import StepTypeForm
from muecke.manage.property.forms import SelectFieldForm
from muecke.manage.property.forms import NumberFieldForm
from muecke.manage.property.forms import StepRangeForm
...
def manage_properties(request):
    ...
    try:
        ...
        url = reverse("muecke_manage_shop_property", kwargs={"id": property.id})
    except IndexError:
        url = reverse("muecke_manage_no_shop_properties")
...
def save_number_field_validators(request, property_id):
    ...
    return muecke.core.utils.set_message_to(response, _(u"Validators have been saved."))
...
def delete_step(request, id):
    ...
    try:
        ...
        url = request.META.get("HTTP_REFERER", reverse("muecke_manage_shop_property"))
    else:
    ...
    return muecke.core.utils.set_message_to(response, _(u"The step has been saved."))
...
def add_property(request, template_name="manage/properties/add_property.html"):
    ...
    return render_to_response(template_name, RequestContext(request, {
        "form": form,
        "properties": Property.objects.filter(local=False),
        "came_from": request.REQUEST.get("came_from", reverse("muecke_manage_shop_properties")),
    }))
...
def delete_property(request, id):
    ...
    try:
        ...
        property.delete()
        _update_property_positions()
        url = reverse("muecke_manage_shop_properties")
