...
from muecke.customer.models import CreditCard
...
class AddressTestCase(TestCase):
    ...
    def setUp(self):
        ...
        shop, created = Shop.objects.get_or_create(name="muecke test", shop_owner="John Doe",
                                          default_country=de)
        shop.save()
    ...
    def test_address_page(self):
        ...
        address_response = self.c.get(reverse('muecke_my_addresses'))
    ...
    def test_create_new_address(self):
        ...
        address_response = self.c.post(reverse('muecke_my_addresses'), address_data)

        self.assertEquals(Address.objects.count(), 4)
        self.assertRedirects(address_response, reverse('muecke_my_addresses'), status_code=302, target_status_code=200,)
