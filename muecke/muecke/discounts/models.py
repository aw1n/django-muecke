...
# muecke imports
import muecke.criteria.utils
from muecke.discounts.settings import DISCOUNT_TYPE_CHOICES
from muecke.discounts.settings import DISCOUNT_TYPE_ABSOLUTE
from muecke.discounts.settings import DISCOUNT_TYPE_PERCENTAGE
from muecke.payment.models import CriteriaObjects
...
class Discount(models.Model):
    ...
    **Attributes:**
    ...
    def is_valid(self, request, product=None):
        ...
        """
        return muecke.criteria.utils.is_valid(request, self, product)
