...
from muecke.core.fields.thumbs import ImageWithThumbsField
from muecke.core.managers import ActiveManager
from muecke.catalog.settings import CHOICES, CONTENT_CATEGORIES
from muecke.catalog.settings import CHOICES_STANDARD
from muecke.catalog.settings import CHOICES_YES
from muecke.catalog.settings import PRODUCT_TYPE_CHOICES
from muecke.catalog.settings import CONFIGURABLE_PRODUCT
from muecke.catalog.settings import STANDARD_PRODUCT
from muecke.catalog.settings import VARIANT
from muecke.catalog.settings import PRODUCT_WITH_VARIANTS
from muecke.catalog.settings import CAT_CATEGORY_PATH
from muecke.catalog.settings import CATEGORY_TEMPLATES
from muecke.catalog.settings import CONTENT_PRODUCTS
from muecke.catalog.settings import LIST
from muecke.catalog.settings import DELIVERY_TIME_UNIT_CHOICES
from muecke.catalog.settings import DELIVERY_TIME_UNIT_SINGULAR
...
from muecke.catalog.settings import PROPERTY_FIELD_CHOICES
...
from muecke.catalog.settings import PROPERTY_STEP_TYPE_CHOICES
from muecke.catalog.settings import PROPERTY_STEP_TYPE_AUTOMATIC
from muecke.catalog.settings import PROPERTY_STEP_TYPE_MANUAL_STEPS
from muecke.catalog.settings import PROPERTY_STEP_TYPE_FIXED_STEP
from muecke.catalog.settings import PROPERTY_VALUE_TYPE_DEFAULT
...
from muecke.catalog.settings import PRODUCT_TEMPLATES
...
from muecke.catalog.settings import THUMBNAIL_SIZES
from muecke.catalog.settings import VARIANTS_DISPLAY_TYPE_CHOICES
from muecke.catalog.settings import CATEGORY_VARIANT_CHEAPEST_PRICE
from muecke.catalog.settings import CATEGORY_VARIANT_CHEAPEST_BASE_PRICE
from muecke.catalog.settings import CATEGORY_VARIANT_CHEAPEST_PRICES
from muecke.catalog.settings import CATEGORY_VARIANT_DEFAULT
...
class Category(models.Model):
    ...
    **Attributes:**
    ...
    def get_absolute_url(self):
        ...
        """
        return ("muecke.catalog.views.category_view", (), {"slug": self.slug})
    ...
    def get_format_info(self):
        ...
        if self.active_formats == True:
            ...
            if self.parent is None:
                try:
                    # TODO: Use cache here. Maybe we need a muecke_get_object,
    ...
    def get_property_groups(self):
        ...
        pgs = muecke.catalog.models.PropertyGroup.objects.filter(products__in=products).distinct()
    ...
    def get_all_products(self):
        ...
        products = muecke.catalog.models.Product.objects.distinct().filter(
            active=True,
    ...
    def get_filtered_products(self, filters, price_filter, sorting):
        ...
        """
        return muecke.catalog.utils.get_filtered_products_for_category(
    ...
    def get_parent_for_portlets(self):
        ...
        return self.parent or muecke.core.utils.get_default_shop()
...
class Product(models.Model):
    ...
    **Parameters:**
    ...
    price_calculator
        Class that implements muecke.price.PriceCalculator for calculating product price.
    ...
    def get_absolute_url(self):
        ...
        """
        return ("muecke.catalog.views.product_view", (), {"slug": self.slug})
    get_absolute_url = models.permalink(get_absolute_url)
    ...
    def get_base_packing_price(self, request, with_properties=True):
        """
        See muecke.plugins.PriceCalculator
        """
    ...
    def get_price_calculator(self, request):
        ...
        if obj.price_calculator is not None:
            ...
            price_calculator = muecke.core.utils.get_default_shop(request).price_calculator

        price_calculator_class = muecke.core.utils.import_symbol(price_calculator)
...
class File(models.Model):
    ...
    **Attributes:**
    ...
    def get_absolute_url(self):
        return reverse("muecke_file", kwargs={"id": self.id})
