...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalog_category', 'image', self.gf('muecke.core.fields.thumbs.ImageWithThumbsField')(max_length=100, null=True, sizes=((60, 60), (100, 100), (140, 140), (200, 200), (300, 300), (350, 350), (400, 400), (800, 600), (800, 800), (950, 350), (960, 350), (962, 350))))
        ...
        db.alter_column('catalog_image', 'image', self.gf('muecke.core.fields.thumbs.ImageWithThumbsField')(max_length=100, null=True, sizes=((60, 60), (100, 100), (140, 140), (200, 200), (300, 300), (350, 350), (400, 400), (800, 600), (800, 800), (950, 350), (960, 350), (962, 350))))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Category.image'
        db.alter_column('catalog_category', 'image', self.gf('muecke.core.fields.thumbs.ImageWithThumbsField')(max_length=100, null=True, sizes=((60, 60), (100, 100), (200, 200), (400, 400))))
        ...
        # Changing field 'Image.image'
        db.alter_column('catalog_image', 'image', self.gf('muecke.core.fields.thumbs.ImageWithThumbsField')(max_length=100, null=True, sizes=((60, 60), (100, 100), (200, 200), (300, 300), (400, 400))))
    ...
    models = {
        ...
        'catalog.category': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('muecke.core.fields.thumbs.ImageWithThumbsField', [], {'blank': 'True', 'max_length': '100', 'null': 'True', 'sizes': '((60, 60), (100, 100), (140, 140), (200, 200), (300, 300), (350, 350), (400, 400), (800, 600), (800, 800), (950, 350), (960, 350), (962, 350))'}),
