...
from muecke.catalog.utils import get_current_top_category
from muecke.caching.utils import muecke_get_object
from muecke.marketing.models import FeaturedProduct
...
class FeaturedPortlet(Portlet):
    ...
    def render(self, context):
        ...
        return render_to_string("muecke/portlets/featured.html", RequestContext(request, {
