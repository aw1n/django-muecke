...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('export_script', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module', self.gf('django.db.models.fields.CharField')(default='muecke.export.generic', max_length=100)),
    ...
    models = {
        ...
        'export.script': {
            ...
            'module': ('django.db.models.fields.CharField', [], {'default': "'muecke.export.generic'", 'max_length': '100'}),
