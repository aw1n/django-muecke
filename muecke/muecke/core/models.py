...
from muecke.checkout.settings import CHECKOUT_TYPES
from muecke.checkout.settings import CHECKOUT_TYPE_SELECT
...
class Shop(models.Model):
    ...
    - price_calculator
        Class that implements muecke.price.PriceCalculator for calculating product
