...
from muecke.catalog.models import Product, Category
...
class ManufacturersTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.c1.save()
        self.m1 = Manufacturer.objects.create(name='LFS C.O.', slug='muecke-co', short_description='sd',
    ...
    def test_manufacturers_page(self):
        ...
        """
        url = reverse("muecke_manufacturers")
    ...
    def test_manufacturer_page(self):
        ...
        """
        url = reverse("muecke_manufacturer", kwargs={'slug': self.m1.slug})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_manufacturer_breadcrumbs(self):
        ...
        # direct visit
        url = reverse("muecke_product", kwargs={'slug': self.p1.slug})
        response = self.client.get(url)
        ...
        url = reverse("muecke_category", kwargs={'slug': self.c1.slug})
        self.client.get(url)
        # then visit the product
        url = reverse("muecke_product", kwargs={'slug': self.p1.slug})
        response = self.client.get(url)
...
class ManufacturersManageTestCase(TestCase):
    ...
    def test_manage_manufacturer(self):
        ...
        """
        url = reverse("muecke_manage_manufacturer", kwargs={'manufacturer_id': self.m1.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)

    def test_add_manufacturer(self):
        url = reverse("muecke_manufacturer_add_manufacturer")
    ...
    def test_manufacturer_dispatcher(self):
        url = reverse("muecke_manufacturer_dispatcher")
        response = self.client.get(url)
        self.assertEqual(response.status_code, 302)

    def test_update_manufacturer(self):
        url = reverse("muecke_manufacturer_update_manufacturer_data", kwargs={'manufacturer_id': self.m1.pk})
    ...
    def test_delete_manufacturer(self):
        url = reverse("muecke_manufacturer_delete_manufacturer", kwargs={'manufacturer_id': self.m1.pk})
        manufacturers_count = Manufacturer.objects.count()
    ...
    def test_manufacturer_products_tab(self):
        url = reverse("muecke_manufacturer_load_products_tab", kwargs={'manufacturer_id': self.m1.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_manage_manufacturer_add_products(self):
        url = reverse("muecke_manage_manufacturer_add_products", kwargs={'manufacturer_id': self.m1.pk})
    ...
    def test_manage_manufacturer_remove_products(self):
        ...
        url = reverse("muecke_manage_manufacturer_remove_products", kwargs={'manufacturer_id': self.m1.pk})
    ...
    def test_manage_manufacturer_selected_products(self):
        ...
        url = reverse("muecke_manage_manufacturer_selected_products", kwargs={'manufacturer_id': self.m1.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, self.p1.name, count=1)
