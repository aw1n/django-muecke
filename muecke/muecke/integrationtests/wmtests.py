...
class CartPriceIntegrationTest(djangotest.WindmillDjangoUnitTest):
    ...
    settings.DEBUG = True
    fixtures = ['muecke_price_test.xml']
    ...
    def setUp(self):
        ...
        self.assertEqual('muecke.net_price.NetPriceCalculator', apple.price_calculator)

        # Check that chocolate is using NetPriceCalculator
        chocolate = Product.objects.get(slug='chocolate')
        self.assertEqual('muecke.gross_price.GrossPriceCalculator', chocolate.price_calculator)
