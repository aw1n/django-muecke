...
from muecke.addresses.settings import INVOICE_ADDRESS_FORM, SHIPPING_ADDRESS_FORM, CHECKOUT_NOT_REQUIRED_ADDRESS
    ...
    **Attributes:**
    ...
    def get_form_model(self):
        ...
        if self.type == "invoice":
            return muecke.core.utils.import_symbol(INVOICE_ADDRESS_FORM)
        else:
            return muecke.core.utils.import_symbol(SHIPPING_ADDRESS_FORM)
    ...
    def render(self, request, country_iso=None):
        ...
        templates = ["muecke/addresses/address_form.html"]
        templates.insert(0, "muecke/addresses/%s_address_form.html" % self.type)
