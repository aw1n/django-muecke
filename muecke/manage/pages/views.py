...
from muecke.manage.pages.forms import PageAddForm
from muecke.manage.pages.forms import PageForm
from muecke.manage.pages.forms import PageSEOForm
...
def manage_pages(request):
    ...
    try:
        ...
        url = reverse("muecke_manage_page", kwargs={"id": page.id})
    except IndexError:
        url = reverse("muecke_add_page")
...
def add_page(request, template_name="manage/pages/add_page.html"):
    ...
    return render_to_response(template_name, RequestContext(request, {
        ...
        "came_from": request.REQUEST.get("came_from", reverse("muecke_manage_pages")),
    }))
...
def delete_page(request, id):
    ...
    return muecke.core.utils.set_message_cookie(
        url=reverse("muecke_manage_pages"),
