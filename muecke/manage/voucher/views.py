...
from muecke.core.utils import render_to_ajax_response
from muecke.tax.models import Tax
from muecke.voucher.models import Voucher
from muecke.voucher.models import VoucherGroup
from muecke.voucher.models import VoucherOptions
from muecke.manage.voucher.forms import VoucherForm
from muecke.manage.voucher.forms import VoucherGroupAddForm
from muecke.manage.voucher.forms import VoucherGroupForm
from muecke.manage.voucher.forms import VoucherOptionsForm
...
def manage_vouchers(request):
    ...
    try:
        ...
        url = reverse("muecke_no_vouchers")
    else:
        url = reverse("muecke_manage_voucher_group", kwargs={"id": voucher_group.id})
...
def add_voucher_group(request, template_name="manage/voucher/add_voucher_group.html"):
    ...
    return render_to_response(template_name, RequestContext(request, {
        "form": form,
        "voucher_groups": VoucherGroup.objects.all(),
        "came_from": request.REQUEST.get("came_from", reverse("muecke_manage_vouchers")),
    }))
...
def delete_voucher_group(request, id):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse("muecke_manage_vouchers"))
    else:
        voucher_group.delete()
        return muecke.core.utils.set_message_cookie(
            url=reverse("muecke_manage_vouchers"),
