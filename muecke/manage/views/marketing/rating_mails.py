...
from muecke.marketing.models import OrderRatingMail
...
def send_rating_mails(request):
    ...
    if request.method == "POST":
        ...
        for order in muecke.marketing.utils.get_orders():
            ...
            # text
            text = render_to_string("muecke/reviews/rating_mail.txt", {
                "order": order,
            ...
            # html
            html = render_to_string("muecke/reviews/rating_mail.html", {
                "order": order,
