...
def manage_payment(request):
    ...
    try:
        ...
        url = reverse("muecke_add_payment_method")
    else:
        url = reverse("muecke_manage_payment_method",
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return muecke.core.utils.set_message_cookie(
                url=reverse("muecke_manage_payment_method", kwargs={"payment_method_id": new_payment_method.id}),
...
def delete_payment_method(request, payment_method_id):
    ...
    return muecke.core.utils.set_message_cookie(
        url=reverse("muecke_manage_payment"),
