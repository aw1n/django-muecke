...
CAT_PRODUCT_PATH = "muecke/catalog/categories/product"   # category with products
CAT_CATEGORY_PATH = "muecke/catalog/categories/category"  # category with subcategories
PRODUCT_PATH = "muecke/catalog/products"   # product templates
IMAGES_PATH = "/media/muecke/icons"  # Path to template preview images
