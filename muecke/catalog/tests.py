...
from muecke.core.signals import property_type_changed
from muecke.catalog.settings import CHOICES_YES
from muecke.catalog.settings import CHOICES_STANDARD
from muecke.catalog.settings import CHOICES_NO
from muecke.catalog.settings import CONTENT_CATEGORIES
from muecke.catalog.settings import PRODUCT_WITH_VARIANTS, VARIANT
from muecke.catalog.settings import DELIVERY_TIME_UNIT_HOURS
from muecke.catalog.settings import DELIVERY_TIME_UNIT_WEEKS
from muecke.catalog.settings import DELIVERY_TIME_UNIT_DAYS
from muecke.catalog.settings import DELIVERY_TIME_UNIT_MONTHS
from muecke.catalog.settings import PROPERTY_NUMBER_FIELD
from muecke.catalog.settings import PROPERTY_SELECT_FIELD
from muecke.catalog.settings import PROPERTY_TEXT_FIELD
from muecke.catalog.settings import PROPERTY_VALUE_TYPE_DISPLAY
from muecke.catalog.settings import PROPERTY_VALUE_TYPE_FILTER
from muecke.catalog.settings import PROPERTY_VALUE_TYPE_VARIANT
from muecke.catalog.settings import QUANTITY_FIELD_INTEGER
from muecke.catalog.settings import QUANTITY_FIELD_DECIMAL_1
from muecke.catalog.settings import QUANTITY_FIELD_DECIMAL_2
from muecke.catalog.settings import STANDARD_PRODUCT
from muecke.catalog.settings import LIST
from muecke.catalog.models import Category
from muecke.catalog.models import DeliveryTime
from muecke.catalog.models import File
from muecke.catalog.models import GroupsPropertiesRelation
...
from muecke.catalog.models import ProductsPropertiesRelation
from muecke.catalog.models import StaticBlock
from muecke.catalog.models import ProductAttachment
from muecke.core.models import Shop
from muecke.core.signals import product_changed
from muecke.core.signals import product_removed_property_group
...
class PriceFilterTestCase(TestCase):
    ...
    def test_get_price_filter_1(self):
        """
        """
        result = muecke.catalog.utils.get_price_filters(self.c1, [], None)
...
class PropertiesTestCase(TestCase):
    ...
    def test_set_filter_1(self):
        ...
        """
        url = reverse("muecke_set_product_filter", kwargs={"category_slug": self.c1.slug, "property_id": 1, "value": "Red"})
        response = self.client.get(url)

        pf = self.client.session.get("product-filter", {})
        self.assertEqual(pf["1"], "Red")

        url = reverse("muecke_set_product_filter", kwargs={"category_slug": self.c1.slug, "property_id": 2, "value": "M"})
        response = self.client.get(url)
    ...
    def test_set_filter_2(self):
        ...
        """
        url = reverse("muecke_set_product_filter", kwargs={"category_slug": self.c1.slug, "property_id": 1, "min": "10", "max": "20"})
        response = self.client.get(url)
    ...
    #
    #     f = muecke.catalog.utils.get_product_filters(self.c1, [], None, None)
    ...
    def test_filter_products(self):
        ...
        products = muecke.catalog.utils.get_filtered_products_for_category(self.c1, filters, None, sorting)
...
class CategoryTestCase(TestCase):
    """Tests the Category of the muecke.catalog.
    """
...
class ViewsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Create a test file
        fh = open(os.path.join(os.getcwd(), "src/muecke/muecke/utils/data/image1.jpg"))
    ...
    def test_file(self):
        ...
        from muecke.catalog.views import file
    ...
    def test_select_variant(self):
        from muecke.catalog.views import select_variant
    ...
    def test_set_price_filter(self):
        from muecke.catalog.views import set_price_filter
        from muecke.catalog.views import reset_price_filter
    ...
    def test_calculate_packing(self):
        from muecke.catalog.views import calculate_packing
    ...
    def test_calculate_price(self):
        from muecke.catalog.views import calculate_price
    ...
    def test_select_variant_from_properties(self):
        from muecke.catalog.views import select_variant_from_properties
    ...
    def test_set_filter(self):
        from muecke.catalog.views import set_filter
    ...
    def test_set_sorting(self):
        ...
        """
        url = reverse("muecke_catalog_set_sorting")
    ...
    def test_category_view(self):
        ...
        """
        url = reverse("muecke_category", kwargs={"slug": "category-1"})
        ...
        self.failIf("muecke/catalog/categories/product/default.html" not in templates)
        self.failIf("muecke/catalog/categories/category/default.html" in templates)
        ...
        self.failIf("muecke/catalog/categories/product/default.html" in templates)
        self.failIf("muecke/catalog/categories/category/default.html" not in templates)
    ...
    def test_product_form_dispatcher(self):
        ...
        """
        url = reverse("muecke_product_dispatcher")
    ...
    def test_product_detail_view(self):
        ...
        """
        url = reverse("muecke_product", kwargs={"slug": "product-1"})
...
class ProductTestCase(TestCase):
    ...
    def test_get_base_price(self):
        ...
        self.p1.price_calculator = "muecke.net_price.NetPriceCalculator"
        self.p1.save()
    ...
    def test_add_product_variants(self):
        ...
        response = self.client.post(reverse('muecke_manage_add_variants', args=(product.id,)), variant_data)
...
class MiscTestCase(TestCase):
    ...
    def test_get_unique_id_str(self):
        from muecke.catalog.models import get_unique_id_str
