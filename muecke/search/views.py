...
from muecke.catalog.settings import STANDARD_PRODUCT, PRODUCT_WITH_VARIANTS, VARIANT


def livesearch(request, template_name="muecke/search/livesearch_results.html"):
    """
    """
    q = request.GET.get("q", "")
...
def search(request, template_name="muecke/search/search_results.html"):
