...
from muecke.core.utils import muecke_pagination


def manufacturers(request,
                  template_name='muecke/manufacturers/manufacturers.html'):
    ...
    pagination_data = muecke_pagination(request, current_page, url=reverse('muecke_manufacturers'))
...
def manufacturer_view(request, slug,
                      template_name="muecke/manufacturers/manufacturer.html"):
    """ Display manufacturer details and products
    """
    start = request.REQUEST.get("start", 1)
    manufacturer = muecke_get_object_or_404(Manufacturer, slug=slug)
...
def manufacturer_products(request, slug, start=1,
                          template_name="muecke/manufacturers/products.html"):
    ...
    # Calculate urls
    pagination_data = muecke_pagination(request,
                                     current_page,
