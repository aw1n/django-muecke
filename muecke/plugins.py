...
from muecke.payment.settings import PM_MSG_TOP
from muecke.payment.settings import PM_MSG_FORM
...
class OrderNumberGenerator(models.Model):
    ...
    **Attributes:**
    ...
    def init(self, request, order):
        ...
        self.customer = muecke.customer.utils.get_customer(request)
        self.cart = muecke.cart.utils.get_cart(request)
...
class PriceCalculator(object):
    ...
    def get_customer_tax_rate(self):
        ...
        """
        from muecke.customer_tax.utils import get_customer_tax_rate
