...
class Cart(models.Model):
    ...
    **Attributes**
    ...
    def amount_of_items(self):
        ...
        """
        logger.info("Decprecated: muecke.cart.models.Cart: the property 'amount_of_items' is deprecated. Please use 'get_amount_of_items'.")
    ...
    def items(self):
        ...
        This method is DEPRECATED.
        """
        logger.info("Decprecated: muecke.cart.models.Cart: the method 'items' is deprecated. Please use 'get_items'.")
    ...
    def get_name(self):
        ...
        This method is DEPRECATED.
        """
        logger.info("Decprecated: muecke.cart.models.Cart: the method 'get_name' is deprecated. (There is no replacement as this method makes no sense at all.)")
        cart_name = ""
    ...
    def get_delivery_time(self, request):
        ...
        for item in self.get_items():
            delivery_time = muecke.shipping.utils.get_product_delivery_time(request, item.product, for_cart=True)
...
class CartItem(models.Model):
    ...
    **Attributes**
    ...
    def get_price(self, request):
        ...
        """
        logger.info("Decprecated: muecke.cart.models.CartItem: the method 'get_price' is deprecated. Please use the methods 'get_price_gross' and 'get_price_net'.")
