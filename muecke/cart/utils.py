...
def get_cart_max_delivery_time(request, cart):
    ...
    """
    logger.info("Decprecated: muecke.cart.utils: the function 'get_cart_max_delivery_time' is deprecated. Please use the method 'get_delivery_time' of the Cart object.")
...
def get_cart_price(request, cart, total=False, cached=True):
    ...
    This function is DEPRECATED.
    """
    logger.info("Decprecated: muecke.cart.utils: the function 'get_cart_price' is deprecated. Please use the method 'get_max_delivery_time' of the Cart object.")
...
def get_go_on_shopping_url(request):
    ...
    if lc:
        ...
        return reverse("muecke_shop_view")
