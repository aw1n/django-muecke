...
from muecke.core.signals import cart_changed
from muecke.core import utils as core_utils
...
def cart(request, template_name="muecke/cart/cart.html"):
    """
...
def added_to_cart(request, template_name="muecke/cart/added_to_cart.html"):
    """
...
def added_to_cart_items(request, template_name="muecke/cart/added_to_cart_items.html"):
    """
