...
from muecke.shipping import utils
from muecke.criteria.models import UserCriterion
...
from muecke.caching.listeners import update_cart_cache
from muecke.tests.utils import create_request


class ShippingMethodTestCase(TestCase):
    """Unit tests for muecke.shipping
    """
